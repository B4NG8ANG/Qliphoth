...
public class Song
{
    ...
    public Song(string _id, string _songName, int _songNormalDifficulty, int _songHardDifficulty, int _songDeathDifficulty, Note[] _chartNormal, Note[] _chartHard, Note[] _chartDeath)
    {
        id = _id;
        songName = _songName;
